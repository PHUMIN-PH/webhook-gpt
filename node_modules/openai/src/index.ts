...
export class OpenAI extends Core.APIClient {
   ...
   * @param {string} [opts.baseURL=process.env['OPENAI_BASE_URL'] ?? https://api.openai.com/v1/completions] - Override the default base URL for the API.
   * @param {number} [opts.timeout=3600] - The maximum amount of time (in milliseconds) the client will wait for a response before timing out.
